package Mir::Config::Client::YAML;
#============================================================= -*-perl-*-

=head1 NAME

Mir::Config::Client::YAML - implements the Mir::R::Config role 
on a YAML encoded configuration file.
...
=head1 SYNOPSIS
    ...
    $o->connect() 
        or die "Error getting a Mir::Config::Client::YAML obj\n";

    # refer to L<Mir::R::Config> role for detailed API documentation

=head1 DESCRIPTION

A class that handles a Mir::Config section stored on a YAML file.
